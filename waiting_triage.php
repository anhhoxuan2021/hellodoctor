...
$_title = 'PHÒNG CHỜ XỬ LÝ - Xin chào bác sĩ';
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">PHÒNG CHỜ XỬ LÝ</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i> PHÒNG CHỜ XỬ LÝ
                            </h1>
                        </div>
                        ...
                        <div class="container1" style="padding-right: 0;padding-left: 0;">
                            ...
                            <br>
                            <div id="page-content" class="waiting-triage-list">
