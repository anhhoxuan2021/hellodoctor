...
$_title = 'THÔNG TIN ĐỊA ĐIỂM - Xin chào bác sĩ';
...
';
$_description = 'THÔNG TIN ĐỊA ĐIỂM';
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">THÔNG TIN ĐỊA ĐIỂM</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader row">
                            <h1 class="subheader-title col-8">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i> THÔNG TIN ĐỊA ĐIỂM
                            </h1>
                        </div>
                        ...
                        <div class="container1" style="padding-right: 0;padding-left: 0;">
                            <div id="location-content">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="col-12 f-bold f-size16">Tên:</div>
                                        <div class="col-12 m-t5 f-bold f-size16">Địa chỉ:</div>
                                        <div class="col-12 m-t5 f-bold f-size16">Số điện thoại:</div>
                                        <div class="col-12 m-t5 f-bold f-size16">Fax:</div>
                                        <div class="col-12 m-t5 f-bold f-size16">Email:</div>
                                        <div class="col-12 m-t5 f-bold f-size16">Địa điểm:</div>
                                    </div>
                                    <div class="col-5">
                                        <div class="col-12 f-size18 color-alert f-bold" id="location-name"></div>
                                        <div class="col-12 m-t5 f-size18" id="adress"></div>
                                        <div class="col-12 m-t5 f-size18" id="phone"></div>
                                        <div class="col-12 m-t5 f-size18" id="fax"></div>
                                        <div class="col-12 m-t5 f-size18" id="email"></div>
                                        <div class="col-12 m-t5 f-size18" id="location-addr"></div>
                                ...
                                <?php
                                   if(count($_SESSION) >0){ ?>
                                       ...
                                       <div class="row m-t15">
                                           <div id="doctors-content" style="width:100%">
        ...
        <script type="text/javascript">
            ...
            var login_ready = "<?= count($_SESSION)?>"


        </script>

        <script src="<?= APP_URL; ?>/js/location/facility_information.js" type="text/javascript"></script>
