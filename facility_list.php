...
$_title = 'DANH SÁCH BỆNH VIỆN - Xin chào bác sĩ';
$_active_nav = 'Facility list';
...
';
$_description = 'DANH SÁCH BỆNH VIỆN';
$type_login =0;
if(count($_SESSION)>0){
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active">DANH SÁCH BỆNH VIỆN</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                        </ol>
                        <div class="subheader row">
                            <h1 class="subheader-title col-8">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i> DANH SÁCH BỆNH VIỆN
                            </h1>
                            <?php
                        ...
                        <div class="container1" style="padding-right: 0;padding-left: 0;">
                            ...
                            <br>
                            <div id="facility-content" class="m-t35" style="width: 100%">

                            </div>

                            <ul id="facility-pagination" class="pagination-sm"></ul>
        ...
        <script src="<?= APP_URL; ?>/js/location/facility_list.js" type="text/javascript"></script>
