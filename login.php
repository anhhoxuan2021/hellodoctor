                ...
                <div class="page-content-wrapper bg-transparent m-0">
                    <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                        <div class="d-flex align-items-center container p-0">
                            ...
                            <a href="<?= APP_URL ?>/register.php" class="btn-link text-white ml-auto">
                                Tạo Tài Khoản
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded" id="login-hide">
                                        <form id="js-login" novalidate="" action="<?= APP_URL ?>/home.php">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" autocomplete="new-password" id="password" class="form-control form-control-lg" placeholder="password" value="password123" required>
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-lg-6 pl-lg-1 my-2">
                                                <button id="btn-login" type="button" class="btn btn-info btn-block btn-lg">Đăng nhập</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
