...
if($_SESSION['user_type_option_user_type'] == "Doctor"){
    $bacsi = $_SESSION['family_name_text']." ".$_SESSION['middle_name_text']." ".$_SESSION['first_name_text'];
    $is_display = '';
}
...
<html lang="en">
    ...
    <body class="mod-bg-1 mod-nav-link ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader row">
                            <h1 class="subheader-title col-8">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i> DANH SÁCH BỆNH NHÂN
                            </h1>
                            <div class="col-4 text-right">
                                <button class="btn btn-succ" id="modal-open-signup"><strong>Thêm bệnh nhân</strong></button>
                            </div>
                        </div>
                        
                        <div class="container1" style="padding-right: 0;padding-left: 0;">
                            <div class="col-12" <?=$is_display?>>
                                <div class="custom-control custom-checkbox margin_b10">
                                    <input type="checkbox" class="custom-control-input" id="patient-for-doctor">
                                    <label class="custom-control-label" for="patient-for-doctor">Bệnh nhân khám bác sĩ: <strong><?=$bacsi?></strong></label>
                                </div>
                            </div>
                            ...
                            <br>
                            <div id="patient-content" style="width: 100%">

                            </div>
                            <div class="col-12 bg-light-gray">Total: <span class="f-bold" id="user-record"></span> users</div>
                            <ul id="patient-pagination" class="pagination-sm"></ul>
        ...
        -->
        <script src="<?= APP_URL; ?>/js/patient/patient_list.js" type="text/javascript"></script>
