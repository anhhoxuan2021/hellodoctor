...
$_title = 'PHÒNG XÉT NGHIỆM - Xin chào bác sĩ';
$_active_nav = 'Lab list';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader row">
                            <h1 class="subheader-title col-8">
                                <i style="color: black" class='subheader-icon fas fa-calendar-check'></i> PHÒNG XÉT NGHIỆM
                            </h1>
                            <?php
                        ...
                        <div class="container1" style="padding-right: 0;padding-left: 0;">
                            ...
                            <br>
                            <div id="lab-content" class="m-t35" style="width: 100%">

                            </div>

                            <ul id="lab-pagination" class="pagination-sm"></ul>
